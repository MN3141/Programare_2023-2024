...
static int shoulder = 0, elbow = 0, leftRot = 0, rightRot = 0;
...
{
    leftRot= (leftRot - 5) % 360;
}
void CALLBACK right(void)
{
    rightRot = (rightRot + 5) % 360;
}
void CALLBACK display(void)
{
    ...
    glRotatef((GLfloat)leftRot, 0, 1, 0);
    glRotatef((GLfloat)rightRot, 0, 1, 0);
    glTranslatef(1.0, 0.0, 0.0);
